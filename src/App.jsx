...
const APP_VERSION="v273-Xandroid";
...
"⚠":(<svg viewBox="0 0 100 100" width="100%" height="100%" style={{display:"block"}}><defs><linearGradient id="apn2" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#1C1C1E"/><stop offset="100%" stopColor="#0A0A0C"/></linearGradient><radialGradient id="apn2bg" cx="50%" cy="50%" r="60%"><stop offset="0%" stopColor="#3A0000"/><stop offset="60%" stopColor="#1C1C1E"/><stop offset="100%" stopColor="#0A0A0C"/></radialGradient></defs><rect x="6" y="6" width="88" height="88" rx="22" fill="url(#apn2bg)"/>{/* poça de sangue grande embaixo (forma orgânica irregular) */}<path d="M22 76 Q18 80 24 84 Q32 88 44 86 Q56 84 66 86 Q76 88 80 82 Q82 76 74 74 Q60 72 50 73 Q36 72 28 74 Z" fill="#8B0000" opacity="0.95"/><path d="M28 78 Q34 82 50 81 Q64 80 72 78" stroke="#5A0000" strokeWidth="0.6" fill="none" opacity="0.7"/>{/* respingo conectado à poça */}<ellipse cx="84" cy="80" rx="5" ry="2.5" fill="#8B0000" opacity="0.85" transform="rotate(20 84 80)"/><circle cx="88" cy="76" r="1.6" fill="#5A0000" opacity="0.85"/><circle cx="14" cy="82" r="2.2" fill="#8B0000" opacity="0.85"/><circle cx="10" cy="78" r="1.4" fill="#5A0000" opacity="0.8"/>{/* silhueta de corpo caído (giz cena de crime) */}<path d="M28 38 Q26 30 30 26 Q34 22 38 26 Q42 30 40 38 L46 42 L42 50 L48 56 L46 64 L44 70 L52 70 L60 66 L66 62 L72 60 Q76 58 76 54 Q76 50 72 50 L62 52 L56 48 L54 42 L60 36 L62 30 Q60 24 54 24 Q48 24 46 30 L46 34 L42 32 Z" fill="rgba(255,255,255,0.92)" stroke="#fff" strokeWidth="1"/>{/* respingos laterais (impacto) */}<ellipse cx="78" cy="22" rx="4" ry="2.5" fill="#8B0000" opacity="0.9" transform="rotate(40 78 22)"/><circle cx="84" cy="18" r="1.8" fill="#5A0000" opacity="0.85"/><circle cx="88" cy="26" r="1.2" fill="#5A0000" opacity="0.75"/><circle cx="74" cy="14" r="1" fill="#8B0000" opacity="0.8"/><ellipse cx="16" cy="20" rx="3.5" ry="2" fill="#8B0000" opacity="0.9" transform="rotate(-30 16 20)"/><circle cx="12" cy="14" r="1.4" fill="#5A0000" opacity="0.8"/><circle cx="22" cy="12" r="1" fill="#8B0000" opacity="0.7"/>{/* gota escorrendo da silhueta */}<ellipse cx="46" cy="74" rx="1.5" ry="3" fill="#8B0000" opacity="0.95"/><ellipse cx="58" cy="76" rx="1.2" ry="2.5" fill="#8B0000" opacity="0.95"/></svg>),
