...
// v252: em iOS, o botão "Croqui PDF" abre direto o AirPrint (única forma confiável
// no iOS 18+, conforme PESQUISA_PDF_iOS.md). Em desktop/Android, fluxo de preview normal.
...
{/* v252: botão extra removido — "Croqui PDF" e "RRV PDF" já usam AirPrint
    automaticamente em iOS (conforme PESQUISA_PDF_iOS.md, recomendação curto prazo) */}
</div></Cd_>
