...
const APP_VERSION="v272-Xandroid";
...
"⚠":(<svg viewBox="0 0 100 100" width="100%" height="100%" style={{display:"block"}}><defs><linearGradient id="apn2" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#FF453A"/><stop offset="100%" stopColor="#8B0000"/></linearGradient><linearGradient id="apn2t" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#FFD60A"/><stop offset="100%" stopColor="#FFB000"/></linearGradient></defs><rect x="6" y="6" width="88" height="88" rx="22" fill="url(#apn2)"/>{/* manchas de sangue espalhadas */}<ellipse cx="20" cy="30" rx="5" ry="3.5" fill="#5A0000" opacity="0.85" transform="rotate(-25 20 30)"/><circle cx="14" cy="38" r="2.2" fill="#5A0000" opacity="0.75"/><ellipse cx="84" cy="22" rx="4.5" ry="3" fill="#5A0000" opacity="0.85" transform="rotate(35 84 22)"/><circle cx="89" cy="30" r="2" fill="#5A0000" opacity="0.7"/><circle cx="78" cy="14" r="1.5" fill="#5A0000" opacity="0.8"/><ellipse cx="18" cy="80" rx="6" ry="4" fill="#5A0000" opacity="0.85" transform="rotate(15 18 80)"/><circle cx="10" cy="74" r="2" fill="#5A0000" opacity="0.7"/><circle cx="28" cy="86" r="1.8" fill="#5A0000" opacity="0.75"/><ellipse cx="84" cy="82" rx="5.5" ry="3.5" fill="#5A0000" opacity="0.85" transform="rotate(-30 84 82)"/><circle cx="92" cy="76" r="1.6" fill="#5A0000" opacity="0.7"/>{/* triângulo central de alerta */}<path d="M50 28 L78 74 L22 74 Z" fill="url(#apn2t)" stroke="#fff" strokeWidth="2" strokeLinejoin="round"/>{/* exclamação */}<rect x="47" y="40" width="6" height="20" rx="2" fill="#1C1C1E"/><circle cx="50" cy="68" r="3" fill="#1C1C1E"/></svg>),
...
"🔫":(<svg viewBox="0 0 100 100" width="100%" height="100%" style={{display:"block"}}><defs><linearGradient id="apn17" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#48484A"/><stop offset="100%" stopColor="#1C1C1E"/></linearGradient><linearGradient id="apn17g" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#3A3A3C"/><stop offset="100%" stopColor="#1C1C1E"/></linearGradient></defs><rect x="6" y="6" width="88" height="88" rx="22" fill="url(#apn17)"/>{/* Glock G19 — slide superior */}<path d="M16 42 L84 42 L84 50 L16 50 Z" fill="url(#apn17g)" stroke="#000" strokeWidth="0.8"/>{/* serrilhas do slide */}<line x1="78" y1="44" x2="78" y2="48" stroke="#1C1C1E" strokeWidth="1"/><line x1="80" y1="44" x2="80" y2="48" stroke="#1C1C1E" strokeWidth="1"/><line x1="82" y1="44" x2="82" y2="48" stroke="#1C1C1E" strokeWidth="1"/>{/* mira frontal */}<rect x="20" y="39" width="3" height="3" fill="#fff"/>{/* mira traseira */}<rect x="74" y="39" width="6" height="3" fill="#fff"/>{/* cano */}<rect x="13" y="44" width="3" height="4" fill="url(#apn17g)"/>{/* corpo + grip frame */}<path d="M44 50 L60 50 L66 80 L40 86 L34 80 L36 60 L44 60 Z" fill="url(#apn17g)" stroke="#000" strokeWidth="0.8"/>{/* trigger guard (guarda mato) */}<path d="M40 50 L40 60 Q40 64 44 64 L52 64 Q56 64 56 60 L56 50" fill="none" stroke="#1C1C1E" strokeWidth="2"/>{/* gatilho */}<path d="M46 56 Q48 60 50 60 Q52 60 54 56" fill="none" stroke="#fff" strokeWidth="1.5"/>{/* grip texture (pontos) */}<circle cx="42" cy="68" r="0.8" fill="#5A5A5C"/><circle cx="46" cy="68" r="0.8" fill="#5A5A5C"/><circle cx="50" cy="68" r="0.8" fill="#5A5A5C"/><circle cx="54" cy="68" r="0.8" fill="#5A5A5C"/><circle cx="42" cy="73" r="0.8" fill="#5A5A5C"/><circle cx="46" cy="73" r="0.8" fill="#5A5A5C"/><circle cx="50" cy="73" r="0.8" fill="#5A5A5C"/><circle cx="54" cy="73" r="0.8" fill="#5A5A5C"/><circle cx="44" cy="78" r="0.8" fill="#5A5A5C"/><circle cx="48" cy="78" r="0.8" fill="#5A5A5C"/><circle cx="52" cy="78" r="0.8" fill="#5A5A5C"/>{/* base do magazine */}<rect x="38" y="84" width="26" height="3" rx="0.5" fill="#000"/>{/* logo G branca discreta */}<text x="50" y="55" textAnchor="middle" fontSize="3.5" fontWeight="800" fill="#5A5A5C">G19</text></svg>),
...
<button type="button" style={{...tb(false),background:"#34c759",color:"#fff",borderColor:"#34c759"}} title="Inserir template de casa" onClick={templateCasa}><AppIcon name="🏠" size={14} mr={4}/>Casa</button>
<button type="button" style={{...tb(false),background:"#5ac8fa",color:"#fff",borderColor:"#5ac8fa"}} title="Inserir template de via pública" onClick={templateRua}><AppIcon name="🛣️" size={14} mr={4}/>Rua</button>
<button type="button" style={tb(false)} onClick={()=>{if(!ctxRef.current)return;pH2();const ctx=ctxRef.current;ctx.save();ctx.strokeStyle="#333";ctx.fillStyle="#333";ctx.lineWidth=1.5;
