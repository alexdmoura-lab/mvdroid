...
"⚠":(<svg viewBox="0 0 100 100" width="100%" height="100%" style={{display:"block"}}><defs><linearGradient id="apn2" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#5AC8FA"/><stop offset="100%" stopColor="#0A84FF"/></linearGradient></defs><rect x="6" y="6" width="88" height="88" rx="22" fill="url(#apn2)"/><path d="M50 22 L80 74 L20 74 Z" fill="#ffcc00" stroke="#a1a1a6" strokeWidth="1"/><rect x="48" y="40" width="4" height="18" rx="2" fill="#0a2540"/><circle cx="50" cy="66" r="2.5" fill="#0a2540"/></svg>),
...
"🔫":(<svg viewBox="0 0 100 100" width="100%" height="100%" style={{display:"block"}}><defs><linearGradient id="apn17" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#5AC8FA"/><stop offset="100%" stopColor="#0A84FF"/></linearGradient></defs><rect x="6" y="6" width="88" height="88" rx="22" fill="url(#apn17)"/><path d="M22 40 L56 40 L56 52 L66 52 L66 40 L78 40 L78 54 L72 64 L56 64 L56 56 L40 56 L40 68 L26 68 L22 56 Z" fill="#f8f8fa" stroke="#a1a1a6" strokeWidth="1"/><rect x="26" y="44" width="28" height="4" fill="#5ac8fa" opacity="0.85"/><circle cx="70" cy="48" r="2.5" fill="#0a2540"/><rect x="30" y="58" width="6" height="8" fill="#5ac8fa" opacity="0.6"/></svg>),
...
return(views[cat]||views.Sedan).map(([v,l])=><button type="button" key={v} style={tb(veiView===v)} onClick={()=>setVeiView(v)}>{l}</button>);})()}</div><div style={{display:"flex",justifyContent:"center",background:dark?"#1a1a1a":"#fafafa",borderRadius:10,padding:12,border:`0.5px solid ${t.bd}`}}>
